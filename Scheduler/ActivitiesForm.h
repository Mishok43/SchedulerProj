...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Size = System::Drawing::Size(765, 2);
			...
			this->textBox->Size = System::Drawing::Size(761, 107);
			...
			this->buttonRemoveTag->Location = System::Drawing::Point(663, 201);
			...
			this->buttonAddTag->Location = System::Drawing::Point(547, 201);
			...
			this->buttonExport->Location = System::Drawing::Point(680, 9);
			...
			this->buttonImport->Location = System::Drawing::Point(580, 9);
			...
			this->dataGridView->Size = System::Drawing::Size(761, 157);
...
private:
	System::Void buttonImport_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (dialog->ShowDialog() == Windows::Forms::DialogResult::OK) {
			...
			MainData.Activities.setVal(Activity::ExcelToActivities(path.c_str()));
	...
	System::Void buttonExport_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (dialog->ShowDialog() == Windows::Forms::DialogResult::OK) {
			...
			Activity::ActivitiesToExcel(MainData.Activities.getVal(), path.c_str());
		}
	}
	...
	System::Void buttonAddTag_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (n > 0)
		{
			...
			{
				for (int i = 0; i < n; i++)
					MainData.ActivitiesFormList[this->dataGridView->SelectedRows[i]->Index]->addTag(GlobalData::MessageBoxInput);
	...
	System::Void buttonRemoveTag_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (n > 0)
		{
			...
			{
				for (int i = 0; i < n; i++)
					MainData.ActivitiesFormList[this->dataGridView->SelectedRows[i]->Index]->removeTag(GlobalData::MessageBoxInput);
